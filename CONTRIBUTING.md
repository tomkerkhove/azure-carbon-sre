...
Use [templates/skill/SKILL.md](templates/skill/SKILL.md) as a starting point. Files under `templates/` are not installed as production skills.
...
- Keep the plugin manifest and README accurate when skills or prerequisites change.
